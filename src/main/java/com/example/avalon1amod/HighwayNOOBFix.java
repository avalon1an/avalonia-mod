...
public class HighwayNOOBFix extends Module {
    private static final double TRIGGER_Y = 119.50;
    ...
    public HighwayNOOBFix() {
        super(
            Categories.Misc,
            "Highway-fix-(without-ob-floor)",
            "Disables ElytraFly, waits 1 second, presses Space, then re-enables ElytraFly when Y is at or below 119.50."
        );
    }
